...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, crazyflie_interfaces, srv, GoTo_Request)() {
  GoTo_Request__rosidl_typesupport_introspection_c__GoTo_Request_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Point)();
  GoTo_Request__rosidl_typesupport_introspection_c__GoTo_Request_message_member_array[4].members_ =
