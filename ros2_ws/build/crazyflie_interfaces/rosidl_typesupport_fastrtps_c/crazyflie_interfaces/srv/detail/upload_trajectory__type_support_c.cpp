...
static size_t _UploadTrajectory_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_crazyflie_interfaces__srv__UploadTrajectory_Request(
    full_bounded, 0);
}
...
static size_t _UploadTrajectory_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_crazyflie_interfaces__srv__UploadTrajectory_Response(
    full_bounded, 0);
}
