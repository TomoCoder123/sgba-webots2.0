...
{
  crazyflie_interfaces__msg__LogBlock * msg = (crazyflie_interfaces__msg__LogBlock *)malloc(sizeof(crazyflie_interfaces__msg__LogBlock));
  if (!msg) {
    return NULL;
  }
...
crazyflie_interfaces__msg__LogBlock__Sequence__init(crazyflie_interfaces__msg__LogBlock__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (crazyflie_interfaces__msg__LogBlock *)calloc(size, sizeof(crazyflie_interfaces__msg__LogBlock));
    if (!data) {
      return false;
    }
...
{
  crazyflie_interfaces__msg__LogBlock__Sequence * array = (crazyflie_interfaces__msg__LogBlock__Sequence *)malloc(sizeof(crazyflie_interfaces__msg__LogBlock__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  crazyflie_interfaces__msg__LogBlock__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    crazyflie_interfaces__msg__LogBlock * data =
      (crazyflie_interfaces__msg__LogBlock *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!crazyflie_interfaces__msg__LogBlock__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          crazyflie_interfaces__msg__LogBlock__fini(&data[i]);
        }
        free(data);
        return false;
      }
