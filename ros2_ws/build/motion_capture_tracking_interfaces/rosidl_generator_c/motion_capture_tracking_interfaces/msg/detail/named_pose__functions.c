...
{
  motion_capture_tracking_interfaces__msg__NamedPose * msg = (motion_capture_tracking_interfaces__msg__NamedPose *)malloc(sizeof(motion_capture_tracking_interfaces__msg__NamedPose));
  if (!msg) {
    return NULL;
  }
...
motion_capture_tracking_interfaces__msg__NamedPose__Sequence__init(motion_capture_tracking_interfaces__msg__NamedPose__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (motion_capture_tracking_interfaces__msg__NamedPose *)calloc(size, sizeof(motion_capture_tracking_interfaces__msg__NamedPose));
    if (!data) {
      return false;
    }
...
{
  motion_capture_tracking_interfaces__msg__NamedPose__Sequence * array = (motion_capture_tracking_interfaces__msg__NamedPose__Sequence *)malloc(sizeof(motion_capture_tracking_interfaces__msg__NamedPose__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  motion_capture_tracking_interfaces__msg__NamedPose__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    motion_capture_tracking_interfaces__msg__NamedPose * data =
      (motion_capture_tracking_interfaces__msg__NamedPose *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!motion_capture_tracking_interfaces__msg__NamedPose__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          motion_capture_tracking_interfaces__msg__NamedPose__fini(&data[i]);
        }
        free(data);
        return false;
      }
