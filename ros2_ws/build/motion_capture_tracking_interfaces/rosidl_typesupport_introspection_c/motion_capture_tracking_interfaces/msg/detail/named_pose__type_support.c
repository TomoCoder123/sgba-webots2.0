...
static rosidl_typesupport_introspection_c__MessageMember NamedPose__rosidl_typesupport_introspection_c__NamedPose_message_member_array[2] = {
  {
    "name",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, motion_capture_tracking_interfaces, msg, NamedPose)() {
  NamedPose__rosidl_typesupport_introspection_c__NamedPose_message_member_array[1].members_ =
