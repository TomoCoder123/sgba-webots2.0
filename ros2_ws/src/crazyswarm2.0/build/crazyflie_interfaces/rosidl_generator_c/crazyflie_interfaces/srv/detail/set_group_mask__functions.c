...
{
  crazyflie_interfaces__srv__SetGroupMask_Request * msg = (crazyflie_interfaces__srv__SetGroupMask_Request *)malloc(sizeof(crazyflie_interfaces__srv__SetGroupMask_Request));
  if (!msg) {
    return NULL;
  }
...
crazyflie_interfaces__srv__SetGroupMask_Request__Sequence__init(crazyflie_interfaces__srv__SetGroupMask_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (crazyflie_interfaces__srv__SetGroupMask_Request *)calloc(size, sizeof(crazyflie_interfaces__srv__SetGroupMask_Request));
    if (!data) {
      return false;
    }
...
{
  crazyflie_interfaces__srv__SetGroupMask_Request__Sequence * array = (crazyflie_interfaces__srv__SetGroupMask_Request__Sequence *)malloc(sizeof(crazyflie_interfaces__srv__SetGroupMask_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  crazyflie_interfaces__srv__SetGroupMask_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    crazyflie_interfaces__srv__SetGroupMask_Request * data =
      (crazyflie_interfaces__srv__SetGroupMask_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!crazyflie_interfaces__srv__SetGroupMask_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          crazyflie_interfaces__srv__SetGroupMask_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  crazyflie_interfaces__srv__SetGroupMask_Response * msg = (crazyflie_interfaces__srv__SetGroupMask_Response *)malloc(sizeof(crazyflie_interfaces__srv__SetGroupMask_Response));
  if (!msg) {
    return NULL;
  }
...
crazyflie_interfaces__srv__SetGroupMask_Response__Sequence__init(crazyflie_interfaces__srv__SetGroupMask_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (crazyflie_interfaces__srv__SetGroupMask_Response *)calloc(size, sizeof(crazyflie_interfaces__srv__SetGroupMask_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  crazyflie_interfaces__srv__SetGroupMask_Response__Sequence * array = (crazyflie_interfaces__srv__SetGroupMask_Response__Sequence *)malloc(sizeof(crazyflie_interfaces__srv__SetGroupMask_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  crazyflie_interfaces__srv__SetGroupMask_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    crazyflie_interfaces__srv__SetGroupMask_Response * data =
      (crazyflie_interfaces__srv__SetGroupMask_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!crazyflie_interfaces__srv__SetGroupMask_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          crazyflie_interfaces__srv__SetGroupMask_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
