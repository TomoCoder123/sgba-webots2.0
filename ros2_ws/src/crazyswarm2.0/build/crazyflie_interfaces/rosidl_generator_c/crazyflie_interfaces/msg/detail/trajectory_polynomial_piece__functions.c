...
{
  crazyflie_interfaces__msg__TrajectoryPolynomialPiece * msg = (crazyflie_interfaces__msg__TrajectoryPolynomialPiece *)malloc(sizeof(crazyflie_interfaces__msg__TrajectoryPolynomialPiece));
  if (!msg) {
    return NULL;
  }
...
crazyflie_interfaces__msg__TrajectoryPolynomialPiece__Sequence__init(crazyflie_interfaces__msg__TrajectoryPolynomialPiece__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (crazyflie_interfaces__msg__TrajectoryPolynomialPiece *)calloc(size, sizeof(crazyflie_interfaces__msg__TrajectoryPolynomialPiece));
    if (!data) {
      return false;
    }
...
{
  crazyflie_interfaces__msg__TrajectoryPolynomialPiece__Sequence * array = (crazyflie_interfaces__msg__TrajectoryPolynomialPiece__Sequence *)malloc(sizeof(crazyflie_interfaces__msg__TrajectoryPolynomialPiece__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  crazyflie_interfaces__msg__TrajectoryPolynomialPiece__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    crazyflie_interfaces__msg__TrajectoryPolynomialPiece * data =
      (crazyflie_interfaces__msg__TrajectoryPolynomialPiece *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!crazyflie_interfaces__msg__TrajectoryPolynomialPiece__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          crazyflie_interfaces__msg__TrajectoryPolynomialPiece__fini(&data[i]);
        }
        free(data);
        return false;
      }
