...
void AddLogging_Request__rosidl_typesupport_introspection_c__AddLogging_Request_init_function(
...
void AddLogging_Request__rosidl_typesupport_introspection_c__AddLogging_Request_fini_function(void * message_memory)
{
  crazyflie_interfaces__srv__AddLogging_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember AddLogging_Request__rosidl_typesupport_introspection_c__AddLogging_Request_message_member_array[3] = {
  {
    "topic_name",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers AddLogging_Request__rosidl_typesupport_introspection_c__AddLogging_Request_message_members = {
  ...
  AddLogging_Request__rosidl_typesupport_introspection_c__AddLogging_Request_message_member_array,  // message members
  AddLogging_Request__rosidl_typesupport_introspection_c__AddLogging_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  AddLogging_Request__rosidl_typesupport_introspection_c__AddLogging_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t AddLogging_Request__rosidl_typesupport_introspection_c__AddLogging_Request_message_type_support_handle = {
  0,
  &AddLogging_Request__rosidl_typesupport_introspection_c__AddLogging_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, crazyflie_interfaces, srv, AddLogging_Request)() {
  if (!AddLogging_Request__rosidl_typesupport_introspection_c__AddLogging_Request_message_type_support_handle.typesupport_identifier) {
    AddLogging_Request__rosidl_typesupport_introspection_c__AddLogging_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &AddLogging_Request__rosidl_typesupport_introspection_c__AddLogging_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void AddLogging_Response__rosidl_typesupport_introspection_c__AddLogging_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void AddLogging_Response__rosidl_typesupport_introspection_c__AddLogging_Response_fini_function(void * message_memory)
{
  crazyflie_interfaces__srv__AddLogging_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember AddLogging_Response__rosidl_typesupport_introspection_c__AddLogging_Response_message_member_array[1] = {
  {
    "success",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers AddLogging_Response__rosidl_typesupport_introspection_c__AddLogging_Response_message_members = {
  "crazyflie_interfaces__srv",  // message namespace
  "AddLogging_Response",  // message name
  1,  // number of fields
  sizeof(crazyflie_interfaces__srv__AddLogging_Response),
  AddLogging_Response__rosidl_typesupport_introspection_c__AddLogging_Response_message_member_array,  // message members
  AddLogging_Response__rosidl_typesupport_introspection_c__AddLogging_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  AddLogging_Response__rosidl_typesupport_introspection_c__AddLogging_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t AddLogging_Response__rosidl_typesupport_introspection_c__AddLogging_Response_message_type_support_handle = {
  0,
  &AddLogging_Response__rosidl_typesupport_introspection_c__AddLogging_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, crazyflie_interfaces, srv, AddLogging_Response)() {
  if (!AddLogging_Response__rosidl_typesupport_introspection_c__AddLogging_Response_message_type_support_handle.typesupport_identifier) {
    AddLogging_Response__rosidl_typesupport_introspection_c__AddLogging_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &AddLogging_Response__rosidl_typesupport_introspection_c__AddLogging_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
