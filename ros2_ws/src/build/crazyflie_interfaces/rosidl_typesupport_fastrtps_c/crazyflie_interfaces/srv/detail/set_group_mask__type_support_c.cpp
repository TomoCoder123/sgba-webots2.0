...
static size_t _SetGroupMask_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_crazyflie_interfaces__srv__SetGroupMask_Request(
    full_bounded, 0);
}
...
static size_t _SetGroupMask_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_crazyflie_interfaces__srv__SetGroupMask_Response(
    full_bounded, 0);
}
