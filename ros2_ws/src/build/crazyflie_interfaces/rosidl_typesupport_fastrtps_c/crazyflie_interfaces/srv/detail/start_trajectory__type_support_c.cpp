...
{
  return max_serialized_size_crazyflie_interfaces__srv__StartTrajectory_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_crazyflie_interfaces__srv__StartTrajectory_Response(
    full_bounded, 0);
}
