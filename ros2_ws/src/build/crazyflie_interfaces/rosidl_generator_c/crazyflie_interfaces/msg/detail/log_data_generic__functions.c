...
{
  crazyflie_interfaces__msg__LogDataGeneric * msg = (crazyflie_interfaces__msg__LogDataGeneric *)malloc(sizeof(crazyflie_interfaces__msg__LogDataGeneric));
  if (!msg) {
    return NULL;
  }
...
crazyflie_interfaces__msg__LogDataGeneric__Sequence__init(crazyflie_interfaces__msg__LogDataGeneric__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (crazyflie_interfaces__msg__LogDataGeneric *)calloc(size, sizeof(crazyflie_interfaces__msg__LogDataGeneric));
    if (!data) {
      return false;
    }
...
{
  crazyflie_interfaces__msg__LogDataGeneric__Sequence * array = (crazyflie_interfaces__msg__LogDataGeneric__Sequence *)malloc(sizeof(crazyflie_interfaces__msg__LogDataGeneric__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  crazyflie_interfaces__msg__LogDataGeneric__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    crazyflie_interfaces__msg__LogDataGeneric * data =
      (crazyflie_interfaces__msg__LogDataGeneric *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!crazyflie_interfaces__msg__LogDataGeneric__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          crazyflie_interfaces__msg__LogDataGeneric__fini(&data[i]);
        }
        free(data);
        return false;
      }
