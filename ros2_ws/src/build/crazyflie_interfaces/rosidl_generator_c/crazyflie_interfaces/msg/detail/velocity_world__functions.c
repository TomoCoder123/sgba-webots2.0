...
{
  crazyflie_interfaces__msg__VelocityWorld * msg = (crazyflie_interfaces__msg__VelocityWorld *)malloc(sizeof(crazyflie_interfaces__msg__VelocityWorld));
  if (!msg) {
    return NULL;
  }
...
crazyflie_interfaces__msg__VelocityWorld__Sequence__init(crazyflie_interfaces__msg__VelocityWorld__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (crazyflie_interfaces__msg__VelocityWorld *)calloc(size, sizeof(crazyflie_interfaces__msg__VelocityWorld));
    if (!data) {
      return false;
    }
...
{
  crazyflie_interfaces__msg__VelocityWorld__Sequence * array = (crazyflie_interfaces__msg__VelocityWorld__Sequence *)malloc(sizeof(crazyflie_interfaces__msg__VelocityWorld__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  crazyflie_interfaces__msg__VelocityWorld__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    crazyflie_interfaces__msg__VelocityWorld * data =
      (crazyflie_interfaces__msg__VelocityWorld *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!crazyflie_interfaces__msg__VelocityWorld__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          crazyflie_interfaces__msg__VelocityWorld__fini(&data[i]);
        }
        free(data);
        return false;
      }
