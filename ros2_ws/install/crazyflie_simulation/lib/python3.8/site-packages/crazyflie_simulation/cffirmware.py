...
class tdoaMeasurement_t(object):
    ...
    anchorPositionA = property(_cffirmware.tdoaMeasurement_t_anchorPositionA_get, _cffirmware.tdoaMeasurement_t_anchorPositionA_set)
    anchorPositionB = property(_cffirmware.tdoaMeasurement_t_anchorPositionB_get, _cffirmware.tdoaMeasurement_t_anchorPositionB_set)
    anchorIds = property(_cffirmware.tdoaMeasurement_t_anchorIds_get, _cffirmware.tdoaMeasurement_t_anchorIds_set)
    anchorIdA = property(_cffirmware.tdoaMeasurement_t_anchorIdA_get, _cffirmware.tdoaMeasurement_t_anchorIdA_set)
    anchorIdB = property(_cffirmware.tdoaMeasurement_t_anchorIdB_get, _cffirmware.tdoaMeasurement_t_anchorIdB_set)
...
RATE_SUPERVISOR = _cffirmware.RATE_SUPERVISOR
...
def controllerPid(control, setpoint, sensors, state, stabilizerStep):
    return _cffirmware.controllerPid(control, setpoint, sensors, state, stabilizerStep)
...
class controllerMellinger_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    mass = property(_cffirmware.controllerMellinger_t_mass_get, _cffirmware.controllerMellinger_t_mass_set)
    massThrust = property(_cffirmware.controllerMellinger_t_massThrust_get, _cffirmware.controllerMellinger_t_massThrust_set)
    kp_xy = property(_cffirmware.controllerMellinger_t_kp_xy_get, _cffirmware.controllerMellinger_t_kp_xy_set)
    kd_xy = property(_cffirmware.controllerMellinger_t_kd_xy_get, _cffirmware.controllerMellinger_t_kd_xy_set)
    ki_xy = property(_cffirmware.controllerMellinger_t_ki_xy_get, _cffirmware.controllerMellinger_t_ki_xy_set)
    i_range_xy = property(_cffirmware.controllerMellinger_t_i_range_xy_get, _cffirmware.controllerMellinger_t_i_range_xy_set)
    kp_z = property(_cffirmware.controllerMellinger_t_kp_z_get, _cffirmware.controllerMellinger_t_kp_z_set)
    kd_z = property(_cffirmware.controllerMellinger_t_kd_z_get, _cffirmware.controllerMellinger_t_kd_z_set)
    ki_z = property(_cffirmware.controllerMellinger_t_ki_z_get, _cffirmware.controllerMellinger_t_ki_z_set)
    i_range_z = property(_cffirmware.controllerMellinger_t_i_range_z_get, _cffirmware.controllerMellinger_t_i_range_z_set)
    kR_xy = property(_cffirmware.controllerMellinger_t_kR_xy_get, _cffirmware.controllerMellinger_t_kR_xy_set)
    kw_xy = property(_cffirmware.controllerMellinger_t_kw_xy_get, _cffirmware.controllerMellinger_t_kw_xy_set)
    ki_m_xy = property(_cffirmware.controllerMellinger_t_ki_m_xy_get, _cffirmware.controllerMellinger_t_ki_m_xy_set)
    i_range_m_xy = property(_cffirmware.controllerMellinger_t_i_range_m_xy_get, _cffirmware.controllerMellinger_t_i_range_m_xy_set)
    kR_z = property(_cffirmware.controllerMellinger_t_kR_z_get, _cffirmware.controllerMellinger_t_kR_z_set)
    kw_z = property(_cffirmware.controllerMellinger_t_kw_z_get, _cffirmware.controllerMellinger_t_kw_z_set)
    ki_m_z = property(_cffirmware.controllerMellinger_t_ki_m_z_get, _cffirmware.controllerMellinger_t_ki_m_z_set)
    i_range_m_z = property(_cffirmware.controllerMellinger_t_i_range_m_z_get, _cffirmware.controllerMellinger_t_i_range_m_z_set)
    kd_omega_rp = property(_cffirmware.controllerMellinger_t_kd_omega_rp_get, _cffirmware.controllerMellinger_t_kd_omega_rp_set)
    i_error_x = property(_cffirmware.controllerMellinger_t_i_error_x_get, _cffirmware.controllerMellinger_t_i_error_x_set)
    i_error_y = property(_cffirmware.controllerMellinger_t_i_error_y_get, _cffirmware.controllerMellinger_t_i_error_y_set)
    i_error_z = property(_cffirmware.controllerMellinger_t_i_error_z_get, _cffirmware.controllerMellinger_t_i_error_z_set)
    prev_omega_roll = property(_cffirmware.controllerMellinger_t_prev_omega_roll_get, _cffirmware.controllerMellinger_t_prev_omega_roll_set)
    prev_omega_pitch = property(_cffirmware.controllerMellinger_t_prev_omega_pitch_get, _cffirmware.controllerMellinger_t_prev_omega_pitch_set)
    prev_setpoint_omega_roll = property(_cffirmware.controllerMellinger_t_prev_setpoint_omega_roll_get, _cffirmware.controllerMellinger_t_prev_setpoint_omega_roll_set)
    prev_setpoint_omega_pitch = property(_cffirmware.controllerMellinger_t_prev_setpoint_omega_pitch_get, _cffirmware.controllerMellinger_t_prev_setpoint_omega_pitch_set)
    i_error_m_x = property(_cffirmware.controllerMellinger_t_i_error_m_x_get, _cffirmware.controllerMellinger_t_i_error_m_x_set)
    i_error_m_y = property(_cffirmware.controllerMellinger_t_i_error_m_y_get, _cffirmware.controllerMellinger_t_i_error_m_y_set)
    i_error_m_z = property(_cffirmware.controllerMellinger_t_i_error_m_z_get, _cffirmware.controllerMellinger_t_i_error_m_z_set)
    z_axis_desired = property(_cffirmware.controllerMellinger_t_z_axis_desired_get, _cffirmware.controllerMellinger_t_z_axis_desired_set)
    cmd_thrust = property(_cffirmware.controllerMellinger_t_cmd_thrust_get, _cffirmware.controllerMellinger_t_cmd_thrust_set)
    cmd_roll = property(_cffirmware.controllerMellinger_t_cmd_roll_get, _cffirmware.controllerMellinger_t_cmd_roll_set)
    cmd_pitch = property(_cffirmware.controllerMellinger_t_cmd_pitch_get, _cffirmware.controllerMellinger_t_cmd_pitch_set)
    cmd_yaw = property(_cffirmware.controllerMellinger_t_cmd_yaw_get, _cffirmware.controllerMellinger_t_cmd_yaw_set)
    r_roll = property(_cffirmware.controllerMellinger_t_r_roll_get, _cffirmware.controllerMellinger_t_r_roll_set)
    r_pitch = property(_cffirmware.controllerMellinger_t_r_pitch_get, _cffirmware.controllerMellinger_t_r_pitch_set)
    r_yaw = property(_cffirmware.controllerMellinger_t_r_yaw_get, _cffirmware.controllerMellinger_t_r_yaw_set)
    accelz = property(_cffirmware.controllerMellinger_t_accelz_get, _cffirmware.controllerMellinger_t_accelz_set)

    def __init__(self):
        _cffirmware.controllerMellinger_t_swiginit(self, _cffirmware.new_controllerMellinger_t())
    __swig_destroy__ = _cffirmware.delete_controllerMellinger_t

# Register controllerMellinger_t in _cffirmware:
_cffirmware.controllerMellinger_t_swigregister(controllerMellinger_t)


def controllerMellingerInit(_self):
    return _cffirmware.controllerMellingerInit(_self)

def controllerMellingerTest(_self):
    return _cffirmware.controllerMellingerTest(_self)

def controllerMellinger(_self, control, setpoint, sensors, state, stabilizerStep):
    return _cffirmware.controllerMellinger(_self, control, setpoint, sensors, state, stabilizerStep)
...
def controllerBrescianini(control, setpoint, sensors, state, stabilizerStep):
    return _cffirmware.controllerBrescianini(control, setpoint, sensors, state, stabilizerStep)
...
def powerDistributionGetIdleThrust():
    return _cffirmware.powerDistributionGetIdleThrust()
...
def assertFail(exp, file, line):
    return _cffirmware.assertFail(exp, file, line)
